...
function makeid() {
    var text = "";
    var possible = "012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789";
...
function jsTreeDisableCheckboxes(jsTreeInst, node_id) {
    var node = jsTreeInst.get_node(node_id);
    if (node !== false) {
        jsTreeInst.disable_node(node);
        node.children.forEach(function (child_id) {
            jsTreeDisableCheckboxes(jsTreeInst, child_id);
        });
    }
}
